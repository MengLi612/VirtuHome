...
namespace RaycastPro.Editor
{
    ...
    public sealed class RCProEditor : Editor
    {
        ...
        public static void DrawSerializedList(
            ...
            GUIContent label,
            Func<int, GUIContent> itemLabel = null,
            ...
            bool draggable = true)
        {
            ...
            for (int i = 0; i < listProperty.arraySize; i++)
            {
                ...
                var guiLabel = itemLabel != null ? itemLabel(i) : new GUIContent($"Element {i}");
                EditorGUILayout.PropertyField(element, guiLabel, true);

                if (showAddRemove && GUILayout.Button("×", GUILayout.Width(20)))
                {
