...
#if UNITY_EDITOR
        internal override string Info => "An advanced, context-aware steering agent that computes a smooth navigation path. It avoids obstacles by probabilistically sampling the environment and leverages a positional memory to resolve complex blockages." + HDependent + HRDetector + HIRadius;
